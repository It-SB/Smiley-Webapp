...
export const Layout423 = (props) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-blue via-blue to-white">
      <section className="bg-gradient-to-b from-blue via-blue text-center to-white px-[5%] text-white py-16 md:py-24 lg:py-28 max-w-6xl rounded-lg shadow-lg">
